...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(prog='vigenere.py',conflict_handler="resolve")
    ...
    parser.add_argument("key",metavar="key",nargs="+",help="The key to encrypt/decrypt the cipher")
    args = parser.parse_args()

    mode = '-e' if args.encrypt == True else '-d'
    key = args.key[0]
