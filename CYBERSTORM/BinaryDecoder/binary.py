...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(prog='binary.py',conflict_handler="resolve")
    parser.add_argument('-b','--bitType',default = 8, help="Set the bitType, (7 or 8 only)")
    ...
    try: 
        result = decode(contents,8) 
    except UnicodeDecodeError:
        result = decode(contents,7)
